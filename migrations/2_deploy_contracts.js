...
module.exports = async function(deployer, network, accounts) {
  await deployer.deploy(CopernicusToken, "Copernicus", "CP", "21", web3.utils.toWei("0.4", "ether").toString(), "https://projectcopernicus.autonomous-times.com/assets/json/ticket_");
